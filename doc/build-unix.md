UNIX BUILD NOTES
====================
Some notes on how to build Neon Core in Unix.
...
memory available when compiling Neon Core. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build Neon Core without wallet.
