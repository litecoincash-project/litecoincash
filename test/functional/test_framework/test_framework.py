...
class BitcoinTestFramework():
    """Base class for a litecoincash test script.

    Individual litecoincash test scripts should subclass this class and override the set_test_params() and run_test() methods.
    ...
    def main(self):
        ...
        parser.add_option("--usecli", dest="usecli", default=False, action="store_true",
                          help="use litecoincash-cli instead of RPC for all commands")
    ...
    def stop_node(self, i):
        """Stop a litecoincashd test node"""
        self.nodes[i].stop_node()
        self.nodes[i].wait_until_stopped()

    def stop_nodes(self):
        """Stop multiple litecoincashd test nodes"""
        for node in self.nodes:
...
class ComparisonTestFramework(BitcoinTestFramework):
    ...
    Sets up some litecoincashd binaries:
