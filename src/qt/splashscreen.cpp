    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    int paddingRight            = 10;   // Neon: Fix ugly spacing on splash screen
    int paddingTop              = 50;
    ...
    QString titleText       = tr("Neon");  // Neon: Show the pretty name, not package name
    ...
    // Neon: Adjusted to show whole logo
