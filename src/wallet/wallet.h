...
static const unsigned int DEFAULT_KEYPOOL_SIZE = 100; //Neon: Falcon-512 keypool size (-10x)
//! -paytxfee default
...
enum WalletFeature
{
    ...
    FEATURE_LATEST = FEATURE_WALLETCRYPT // use FEATURE_WALLETCRYPT as latest version
};
