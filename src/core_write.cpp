...
UniValue ValueFromAmount(const CAmount& amount)
{
    ...
    return UniValue(UniValue::VNUM,
            strprintf("%s%d.%07d", sign ? "-" : "", quotient, remainder));   // Neon: Updated num decimals
}
...
const std::map<unsigned char, std::string> mapSigHashTypes = {
    ...
    {static_cast<unsigned char>(SIGHASH_ALL|SIGHASH_FORKID), std::string("ALL|FORKID")}, 											// Neon: Replay attack protection
    {static_cast<unsigned char>(SIGHASH_NONE|SIGHASH_FORKID), std::string("NONE|FORKID")},											// Neon: Replay attack protection
